...
<body style=" background: linear-gradient(to right, lightgreen,khaki);">
  ...
  <form method='post' style="text-align: center; margin-top: 3vmin;">
    Login: <br/> <input type="text" placeholder="Twój login" name="login" /><br/>
    <?php
      //login error
    ...
    ?>
    Email: <br/> <input type="text" placeholder="Twój email" name="email" /><br/>
    <?php
      //email error
    ...
    ?>
    Hasło: <br/> <input type="password" placeholder="Twoje hasło" name="haslo" /><br/>
    <?php
      //haslo error
    ...
    ?>
    Powtórz hasło: <br/> <input type="password" placeholder="Twoje hasło" name="haslo2" /><br/>
    <label>
